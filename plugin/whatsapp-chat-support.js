 ...
 * ====================================================================== */    
    ...
    WhatsappChatSupport.DEFAULTS = {
        ...
        notAvailableMsg             :   'Cerrado Hoy', // message when its not an available day or once the available hours have passed
        almostAvailableMsg          :   'Offline - Abrimos a las 9 AM', // if today is an available day and before the time starts
        dialogNotAvailableMsg       :   'Offline - Abrimos a las 9 AM de Lun-Vie', // message when its not an available day or once the available hours have passed
        dialogAlmostAvailableMsg    :   'Offline - Abrimos a las 9 AM', // if today is an available day and before the time starts
